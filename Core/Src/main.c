...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, D2_Pin|D3_Pin|SRCLK_Pin|SER_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : D2_Pin D3_Pin SRCLK_Pin SER_Pin */
  GPIO_InitStruct.Pin = D2_Pin|D3_Pin|SRCLK_Pin|SER_Pin;
  ...
  GPIO_InitStruct.Pin = RCLK_Pin|D4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
